      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              {["Web Development", "UI/UX Design", "Frontend Development", "Animation & GSAP"].map((service) => (
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-slate-400 text-sm">
            Made with <span className="text-red-400">❤️</span> by <span className="text-blue-400">Somesh</span>
          </p>
          <p className="text-slate-500 text-sm">© 2024 Somesh. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
